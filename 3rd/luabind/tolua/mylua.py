...
def main():
    ...
    cxx_generator_root = os.path.abspath(os.path.join(project_root, 'luabind/bindings-generator'))
    ...
    try:
        ...
        tolua_root = '%s/luabind/tolua' % project_root
        output_dir = '%s/luabind/tolua/auto' % project_root

        cmd_args = {'mylua.ini' : ('mytestclass', 'lua_mytestclass')}
        target = 'lua'
